      ...
      <div className="navbar bg-base-100 dark:bg-slate-900 dark:text-white">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <a className="text-xl font-bold cursor-pointer ">Nigareshat.com</a>
       </div>
        ...
        <div className="navbar-center hidden lg:flex">
          ...
          <ul className="menu menu-horizontal px-1">{navItems}</ul>
                ...
                <label className="input px-3 py-2 border-black rounded-md flex items-center gap-2 dark:bg-slate-900 dark:text-white dark:border-white">
                <input type="text" className="grow  py-2 px-5" placeholder="Search" />
